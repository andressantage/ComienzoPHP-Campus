...
<div class="caja">
    <div class="container d-flex justify-content-center align-items-center flex-column">
        <div class="container d-flex justify-content-center align-items-center flex-colun">
            <?php  if(isset($_SESSION['correo'])){?>
                <p class="nombre"><?php echo  "Hola ".$_SESSION['nombre']." buen dia :)"; ?> </p>
            <?php }?>
    ...
    <form method="POST"> 
        <table>
            ...
            <tr>
               <!--  <td class="espacioBoton" colspan="2"><a href="salir.php"><button class="btn btn-warning tablero espacioBoton letraBoton">Cerrar sesión</button></a></td>
